                ...
                <div class="form-grids row"  style="width: 50%;"> 
                    ...
                    <div class="form-body">
                        ...
                        if (isset($_GET['id']) && !empty($_GET['id'])) {
                            $strSQL = "SELECT * FROM tests where id='" . $_GET['id'] . "'";
                            $rs = mysql_query($strSQL);
                            $row = mysql_fetch_array($rs);
                            ?>
                        <form enctype="multipart/form-data" method="post" action="addTestCode.php"> 

                                <div class="form-group"> 
                                    <label for="Name">Test Name</label> 
                                    <input type="text" class="form-control" id="testname"  name="testname" required="" value="<?php echo $row['testname']; ?>"> 
