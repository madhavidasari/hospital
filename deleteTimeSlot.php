...
<div class="main-content" style="margin-top: 5%;">
    ...
    <div id="page-wrapper" style="background: #fff;">
        <div class="main-page">
            <div class="tables">
                <h3 class="title1">Time Slots</h3> 
                <?php
                $strSQL = "SELECT * FROM timeslots";
                ...
                <div class="table-responsive widget-shadow" style="width:50%;">                     
                    <h4>No Time Slots Added by Admin</h4>
                    </div>
                <?php } else {?>
                <div class="table-responsive widget-shadow" style="width:50%;"> 
                        ...
                        <table class="table"> 
                            ...
                            <tbody>  
                                <?php while ($row = mysql_fetch_array($rs)) { ?>
                                        <tr>                                         
                                            <td>Action</td>  
                                            <td><a href="deleteTimeSlotCode.php?id=<?php echo $row['id']; ?>"><span class="label label-danger">Delete</span></a></td>
                                        </tr>
